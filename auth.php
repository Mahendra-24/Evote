    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="portal.php" class="navbar-brand headerFont text-lg"><strong>eVoting</strong></a>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-4 text-center" style="border:2px solid gray;padding:50px;">
          ...
          if (!empty($_POST["emailID"])) {
            if (empty($_POST['emailID']) || empty($_POST['adminPassword'])) {
              ...
              $sql = "SELECT * FROM db_evoting.tbl_users WHERE email='" .$emailID. "' AND pass='".$password. "'";
              ...
              if (mysqli_num_rows($query)>=1 )   {
                ...
                echo "<br><a href='users.html' class='btn btn-primary'><span class='glyphicon glyphicon-refresh'></span> <strong>Try Again</strong></a>";
              }

              mysqli_close($conn);
            }
          } else if (!empty($_POST['adminUserName'])) {
