...
<body>
    ...
    " role="navigation">
        	...
        	-->
                    ...
                    <button type="submit" class="btn btn-success navbar-right navbar-btn"><span class="normalFont"><strong>Sign Panel</strong></span></button>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4" style="border:2px solid gray;padding:50px;">
                    ...
                    <div class="page-header">
                        <h2 class="specialHead"> Update User's Password</h2>
                    </div>

                    <form action="updatePwd.php" method="POST">
                        <div class="form-group">
                            <label for="">Old Password</label><br>
                            <input type="text" name="userExistingPass" placeholder="Enter Old Password" class="form-control"><br>
                            ...
                            <input type="text" name="emailID" class="form-control" placeholder="Enter Existing Email ID"><br>
