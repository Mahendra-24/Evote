      ...
      <div class="row">
        ...
        <div class="col-sm-4 text-center" style="border:2px solid gray;padding:50px;">
          ...
          if (isset($_POST["submit"])) {
            if (isset($_POST["voterName"]) && isset($_POST["voterEmail"]) && isset($_POST["loginPass"])&& isset($_POST["voterID"])) {
          ...
          $sql = "INSERT INTO db_evoting.tbl_users VALUES(null,'" . $name . "','" . $email . "','" . $password . "','" . $voterID . "');";


          if (mysqli_query($conn, $sql)) {
            echo "<img src='images/success.png' width='70' height='70'>";
            echo "<h3 class='text-info specialHead text-center'><strong> YOU'VE  SUCCESSFULLY REGISTERED.</strong></h3>";
